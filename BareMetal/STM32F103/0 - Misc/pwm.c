...
#define LED_CR              CRH
#define LED_SET             GPIO_BSRR_BS0
#define LED_RESET           GPIO_BSRR_BR0
#define LED_PORT_RESET_BITS GPIO_CRH_MODE0 | GPIO_CRH_CNF0
#define LED_PORT_SET_BITS   GPIO_CRH_MODE0_1 | GPIO_CRH_MODE0_0
#define LED_CLOCK           RCC_APB2ENR_IOPAEN

// PWM defines
#define PULSE_MIN           480            // 1000  탎 = 1 ms
#define PULSE_CENTER        1340            // 1500  탎 = 1.5 ms
#define PULSE_MAX           2225            // 2000  탎 = 2 ms
#define PULSE_FREQ          50              // 20000 탎 = 20 ms
...
//#define PRESCALE_1MHZ       1000000         // 1 Mhz prescale
    ...
    // set prescale to be F = 1 MHz ; T = 0.000001 = 1탎
